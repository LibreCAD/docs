...
# -*- coding: utf-8 -*-
#
# LibreCAD documentation build configuration file, created by
...
##
##   app.add_css_file('theme_overrides.css')  [app.add_css_file(...) as app. add_stylesheet(...) has been deprecated] <- Wrong!
##
## or
